<section data-id="charges" id="nhs-price-list" class="py-[120px] bg-light max-lg:pt-[80px] max-lg:pb-[60px]">
  <div class="charges__inner">
    <div class="charges__container">
      <div class="charges__text" data-opacity-move><?php the_field('charges-text'); ?></div>
      <div
        class="grid grid-cols-3 gap-[21px] ml-[112px] max-xl:ml-0 max-lg:max-w-[500px] max-lg:mx-auto max-lg:grid-cols-1 max-lg:gap-[60px]">
        <?php if( have_rows('charges-list') ): ?>
        <?php while( have_rows('charges-list') ): the_row(); 
